    ...
    <div className="space-y-12 sm:space-y-16 py-4 sm:py-8 animate-fade-in text-left">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Item 1 */}
          <div className="bento-card p-6 rounded-2xl border border-[var(--bento-border)] space-y-4 flex flex-col justify-between">
            ...
            <button
              ...
              className="w-full py-2 px-3 rounded-xl bg-[var(--bento-input)] hover:bg-[var(--bento-card-hover)] border border-[var(--bento-border)] text-xs font-semibold text-[var(--bento-text)] flex items-center justify-center gap-2 cursor-pointer transition-colors"
            >
