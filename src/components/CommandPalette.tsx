...
interface CommandPaletteProps {
  isOpen: boolean;
  onClose: () => void;
  setActiveTab: (tab: ActiveTab, section?: any) => void;
  openBriefModal: () => void;
}
  ...
  const osModules = [
    {
      ...
      description: "Primary workspace pulse: Today view, next actions, quick briefs & active projects",
      icon: <Clock className="w-4 h-4 text-red-500" />,
      action: () => {
        setActiveTab("command-center", "home");
        onClose();
      },
    },
    {
      ...
      description: "All creative production, marketing and release projects in one place",
      icon: <Briefcase className="w-4 h-4 text-blue-400" />,
      action: () => {
        setActiveTab("command-center", "projects");
        onClose();
      },
    },
    {
      ...
      description: "Asset library, uploaded files, stems, cover art and documents",
      icon: <HardDrive className="w-4 h-4 text-emerald-400" />,
      action: () => {
        setActiveTab("command-center", "library");
        onClose();
      },
    },
    {
    ...
    },
    {
      ...
      description: "Brand core, visual guidelines, sprint campaign launcher & documents hub",
      icon: <Sparkles className="w-4 h-4 text-blue-400" />,
      action: () => {
        setActiveTab("command-center", "brand");
        onClose();
      },
    },
    {
      id: "nav-requests",
      title: "Studio Requests & Deliveries",
      description: "Track all commissioned creative work, revisions, approvals, and deliveries",
      icon: <Palette className="w-4 h-4 text-pink-400" />,
      action: () => {
        setActiveTab("command-center", "requests");
        onClose();
      },
    },
    {
