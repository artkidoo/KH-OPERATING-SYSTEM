...
export const CampaignBuilder: React.FC<CampaignBuilderProps> = ({ onNotify, onNavigateTab }) => {
  ...
  // Phase 1: CampaignBuilder is a legacy read-only surface. New work belongs
  // in Projects; each campaign can migrate safely (source data preserved).
  ...
  const handleCreateNewCampaign = async () => {
    onNotify('Campaign creation is deprecated — create a Project instead. Existing campaigns can migrate safely.', 'error');
    return;
