        ...
        return [
          {
            ...
            actionLabel: "Open Music Workspace",
            category: "core",
          },
          {
            id: "cover-art",
            label: "Request Master Cover Artwork",
            description: "Submit references and moodboard for KeedoHub Studio designers",
            completed: assetsCount > 0,
            actionTab: "command-center",
            actionLabel: "Request Artwork",
            category: "assets",
          },
          {
            id: "release-kit",
            label: "Review Release Asset Kit",
            description: "Track cover artwork, Spotify canvas, and motion package deliverables",
            completed: Boolean(releasesCount > 0),
            actionTab: "command-center",
            actionLabel: "View Asset Kit",
            category: "launch",
          },
          {
            id: "content-schedule",
            label: "Access Turnkey Asset Kits",
            description: "Download turnkey TikTok, Reels, and Carousel assets produced by Studio",
            completed: contentCount >= 3,
            actionTab: "command-center",
            actionLabel: "Open Asset Kits",
            category: "content",
          },
          {
            id: "split-sheets",
