...
const STUDIO_SERVICES: StudioServiceDef[] = [
  ...
  },
  {
    ...
    domain: "artist",
    title: "Release Asset Kit",
    tagline: "Complete release package: artwork, canvas, social, EPK assets",
    description: "Everything needed for a successful release: master artwork, Spotify Canvas, social media assets, press kit visuals, and digital distributor upload files.",
    turnaround: "3-5 Business Days",
    priceUsd: "$450",
    priceNgn: "₦400,000",
    budgetNumber: 450,
    idealFor: "Major singles, EP releases, Album launches, Debut projects",
    deliverables: [
      "Complete Cover Art Suite (Front/Back/Tracklist)",
      "Spotify Canvas & Apple Music Artwork",
      "Social Media Launch Pack (10+ formats)",
      "Digital Distributor Upload Package",
      "EPK Visual Assets",
    ],
  ...
  },
  {
    ...
    domain: "artist",
    title: "Motion",
    tagline: "Animated logos, lyric videos & promotional motion graphics",
    description: "Professional motion design for music: animated logo reveals, lyric video animation, music video style frames, and promotional motion content.",
    turnaround: "4-6 Business Days",
    priceUsd: "$500",
    priceNgn: "₦450,000",
    budgetNumber: 500,
    idealFor: "Single launches, Album rollouts, Tour promotions, Brand animation",
    deliverables: [
      "Animated Logo Reveal (3s & 6s versions)",
      "Lyric Video Animation (full song)",
      "Music Video Style Frame Concepts",
      "Social Motion Snippets (9:16, 1:1)",
    ],
  ...
  },
  {
    ...
    domain: "artist",
    title: "Lyric Visuals",
    tagline: "Timed lyric videos, karaoke visuals & text-based motion content",
    description: "Professional lyric video production with synchronized timing, kinetic typography, and engaging visual treatments that keep viewers watching.",
    turnaround: "3-5 Business Days",
    priceUsd: "$350",
    priceNgn: "₦320,000",
    budgetNumber: 350,
    idealFor: "Single releases, YouTube premieres, TikTok lyric clips, Karaoke content",
    deliverables: [
      "Full Lyric Video (16:9 HD)",
      "Lyric Snippets (9:16 for Reels/TikTok)",
      "LRC Timestamped File",
      "Karaoke Version with Visual Cues",
    ],
  ...
  },
  {
    ...
    domain: "artist",
    title: "EPK",
    tagline: "Electronic Press Kit: bio, music, visuals, contact & assets",
    description: "Complete electronic press kit for booking agents, curators, and media: professional bio, music samples, high-res visuals, press quotes, and contact information.",
    turnaround: "2-3 Business Days",
    priceUsd: "$200",
    priceNgn: "₦180,000",
    budgetNumber: 200,
    idealFor: "Booking submissions, Festival applications, Media pitches, Label showcases",
    deliverables: [
      "Multi-page EPK PDF (Print & Digital)",
      "Web EPK Landing Page",
      "Press Photo Selection (High-Res)",
      "Music Sample Links & QR Codes",
    ],
  ...
  },
  {
    ...
    tagline: "Complete artist identity: logo, colors, typography & brand guide",
    description: "Full artist branding system: logo marks, color palette, typography hierarchy, brand guidelines document, and consistent visual identity across all platforms.",
    turnaround: "5-7 Business Days",
    priceUsd: "$600",
    priceNgn: "₦540,000",
    budgetNumber: 600,
    idealFor: "New artist launches, Rebrands, Label signees, Career-defining moments",
    deliverables: [
      "Primary & Secondary Logo Marks",
      "Complete Color Palette with Hex/RGB/CMYK",
  ...
  },
  {
    ...
    domain: "artist",
    title: "Social Content",
    tagline: "Social media graphics, reels covers & engagement assets",
    description: "Engaging social media content: post templates, reel covers, story graphics, announcement visuals, and content series designs that build audience connection.",
    turnaround: "2-3 Business Days",
    priceUsd: "$250",
    priceNgn: "₦225,000",
    budgetNumber: 250,
    idealFor: "Release promotions, Tour announcements, Profile refreshes, Content series",
    deliverables: [
      "Social Media Post Templates (10+ designs)",
      "Reel/Story Covers (9:16 suite)",
      "Announcement Graphics Suite",
  ...
  // ==========================================
  {
    ...
    tagline: "Complete identity system: logo, colors, typography & guidelines",
    description: "Professional brand identity foundation: primary and secondary logos, color system, typography hierarchy, brand guidelines, and consistent visual language.",
    turnaround: "5-7 Business Days",
    priceUsd: "$650",
    priceNgn: "₦580,000",
    budgetNumber: 650,
    idealFor: "New brands, Rebrands, Startup launches, Company refreshes",
    deliverables: [
      "Primary & Secondary Logo Marks (Vector)",
      "Complete Color System with Tokens",
      "Typography Hierarchy & Pairing",
      "Brand Guidelines Document (PDF)",
      "Brand Asset Package (All Formats)",
    ],
  ...
  },
  {
    ...
    tagline: "Complete social presence: posts, stories, banners & templates",
    description: "Full social media visual system: post templates, story designs, profile headers, announcement graphics, and platform-specific optimized assets.",
    turnaround: "3-4 Business Days",
    priceUsd: "$350",
    priceNgn: "₦315,000",
    budgetNumber: 350,
    idealFor: "Brand launches, Campaign rollouts, Social refreshes, Content series",
    deliverables: [
  ...
  },
  {
    ...
    tagline: "UI/UX design, wireframes & interactive prototypes",
    description: "Professional digital product design: website wireframes, UI designs, interactive prototypes, design systems, and developer-ready specifications.",
    turnaround: "5-10 Business Days",
    priceUsd: "$750",
    priceNgn: "₦675,000",
    budgetNumber: 750,
    idealFor: "New websites, App launches, Redesigns, Landing pages",
    deliverables: [
      "Complete Wireframe Set",
      "High-Fidelity UI Designs (All Screens)",
  ...
  },
  {
    ...
    domain: "brand",
    title: "Complete Brand Creative System",
    tagline: "Enterprise turnkey: identity + documents + presentations + social + assets",
    ...
    priceNgn: "₦1,080,000",
    budgetNumber: 1200,
    idealFor: "New company launch, Strategic rebrand, Venture-backed startups, Enterprise",
    deliverables: [
