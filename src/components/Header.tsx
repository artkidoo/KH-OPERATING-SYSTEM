...
export const Header: React.FC<HeaderProps> = ({
  ...
  const { user, workspaces, activeWorkspace, switchWorkspace, logout, openOnboarding, isDemo } = useAuth();
  ...
  // Phase 2: customer nav is workspace-oriented (MY WORKSPACE / PROJECTS /
  // LIBRARY / REQUESTS). Internal engine names stay out of the header.
  const wsNav = workspaceNavFor(activeWorkspace?.identityType);
  void wsNav;
              ...
              >
                ...
                <div className="flex flex-col text-left">
                  <div className="flex items-center gap-1">
                    ...
                    {isDemo && (
                      <span className="text-[8px] sm:text-[9px] font-mono px-1.5 py-0.2 rounded-full bg-amber-500/20 text-amber-400 border border-amber-500/40 font-bold tracking-wider">
                        DEMO
                      </span>
                    )}
                  </div>
