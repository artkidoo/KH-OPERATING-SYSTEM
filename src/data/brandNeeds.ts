...
export const brandNeedCategories: BrandNeedCategoryConfig[] = [
  ...
  },
  {
    ...
    needs: [
      ...
      { id: "epk", label: "Electronic Press Kit", description: "A professional profile for media, partners, and bookers.", actionTab: "studio", studioServiceCategory: "business_documents", recommendedFor: ["artist", "creator"] },
  ...
  },
  {
    ...
    needs: [
      ...
      { id: "social-profiles", label: "Social Media Profiles", description: "Consistent, complete profiles where customers spend time.", actionTab: "brand-os", recommendedFor: ["artist", "creator", "automotive", "restaurant"] },
      { id: "social-media-kit", label: "Social Media Kit", description: "Reusable profile and post assets for consistent publishing.", actionTab: "brand-os", recommendedFor: ["artist", "creator"] },
  ...
  },
  {
    ...
    needs: [
      { id: "social-content", label: "Social Media Content", description: "Useful, consistent content for your audience.", actionTab: "brand-os" },
      ...
      { id: "vehicle-content", label: "Vehicle Content", description: "Content that makes vehicles easy to discover and compare.", actionTab: "brand-os", recommendedFor: ["automotive"] },
      { id: "campaign-creatives", label: "Campaign Creatives", description: "A coherent set of assets for a campaign.", actionTab: "brand-os" },
      { id: "content-strategy", label: "Content Strategy", description: "A purposeful plan for what to publish and why.", actionTab: "brand-os" },
  ...
  },
  {
    ...
    needs: [
      ...
      { id: "customer-follow-up", label: "Customer Follow-up", description: "A repeatable way to keep conversations moving.", actionTab: "command-center", recommendedFor: ["automotive", "business", "brand", "restaurant", "startup"] },
  ...
  },
  {
    ...
    needs: [
      ...
      { id: "analytics", label: "Analytics", description: "Measurement that informs better decisions.", actionTab: "brand-os" },
